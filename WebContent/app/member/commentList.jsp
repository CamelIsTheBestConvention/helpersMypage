		...
		<div class="my-page-container">
			<div class="list-container">
				<section class="title-section">
					<h1 class="title">도움 주기 목록</h1>
				</section>
				<ul class="tab-list">
					<a href="/member/PostList.me">
						<li class="tab">작성 글</li>
					</a>
					<li class="tab tab-selected">작성 댓글</li>
				</ul>
				<section class="content-section">
					...
					<ul class="content-list">
						<c:forEach var="comment" items="${comments}">
							<li class="content-item" id="${list.getCommentId()}"><a href=""
								class="content-item-link">
									<div class="content-item-container">
										...
										<div class="collapsed">
											<div class="line-clamp">
												<p class="content">
													<c:out value="${comment.getBoardTitle()}" />
												</p>
											</div>
										</div>
										<span class="content-item-date"><c:out
												value="${comment.getCommentDate()}" /></span>
									</div>
							</a>
								<div class="content-udcs-container">
									<button class="content-delete-btn">삭제하기</button>
								</div></li>
						</c:forEach>
					</ul>
				</section>
